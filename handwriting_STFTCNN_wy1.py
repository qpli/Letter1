...
# 批量读取灰度图片
data_dir=r'./gray_picture_1024_512_1024'
...
history=model.fit(data_X,train_Y,epochs=20,batch_size=18,validation_split=0.2)
...
data.save('./lqp_handwriting_result.xls')
