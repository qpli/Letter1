...
matfn=r'C:\handwriting\20181210_wxy_812_ultraGesture_pauseRecordDemo\label.mat'
data = sio.loadmat(matfn)

# 批量读取灰度图片
data_dir=r'C:\handwriting\20181210_lqp_812_ultraGesture_pauseRecordDemo\gray_picture_1024_512_1024'
str1=data_dir + '/*.jpg'
...
model.fit(data_X,train_Y,epochs=300,batch_size=20,validation_split=0.2)
...
for kk in range(10,15):
    ...
    #==========将预测标签写入excel中=========================================================================================
    data=xlwt.Workbook()
    table = data.add_sheet('CNN_layer_'+kk,cell_overwrite_ok=True)
...
data.save('E:/声音小组\LQPHP/audiotrack/matlab_code/mousedetect/data/806HPhxy_9种识别/lqp_sushe_conchirp_handwriting_CNN9feature_512_test03_RMSprop.xls')
