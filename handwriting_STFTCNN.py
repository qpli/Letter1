...
matfn=r'E:\声音小组\LQPHP\audiotrack\matlab_code\handwriting\20181211twl_812_ultraGesture_vivo_A_Z_pauseRecordDemo\label.mat'
data = sio.loadmat(matfn)

#批量读取灰度图片
data_dir=r'E:\声音小组\LQPHP\audiotrack\matlab_code\handwriting\20181210_lqp_812_ultraGesture_pauseRecordDemo\gray_picture_1024_512_1024'
str1=data_dir + '/*.jpg'
...
model.add(Conv2D(64,(8,8),strides=(1,1),padding='same',activation='tanh',kernel_initializer='uniform'))#没有这一层是89%
...
history=model.fit(data_X,train_Y,epochs=3000,batch_size=20,validation_split=0.2)
...
data.save('./20181210_wxy_812_ultraGesture_pauseRecordDemo_handwriting_CNN9feature_512_test03_RMSprop.xls')
