...
# matlab文件名
matfn=u'E:/声音小组/LQPHP/audiotrack/matlab_code/mousedetect/data/806HPhxy_9种识别/mouse_806_HP_wxy_20181101_STFT_tz_tz1_label_mapminmax01.mat'
...
train = data['tz1']
target = data['label']
print('tarin.shape:',train.shape)
#
train = np.reshape(train,(train.shape[0],train.shape[1],train.shape[2],1)).astype('float32')
...
model.add(Conv2D(128, (3,3), activation='tanh', input_shape=(data_X.shape[1], data_X.shape[2],1)))
...
tb=TensorBoard(log_dir='./logs',histogram_freq=1,batch_size=10,write_graph=True,write_grads=False,write_images=False,embeddings_freq=0,embeddings_layer_names=None,embeddings_metadata=None)
callbacks=[tb]


history=model.fit(data_X,train_Y,epochs=60,batch_size=6,validation_split=0.2)
...
data.save('E:/声音小组\LQPHP/audiotrack/matlab_code/mousedetect/data/806HPhxy_9种识别/806_812_HP_wxy_20181101_tz1_CNN9feature_test05_RMSprop.xls')
