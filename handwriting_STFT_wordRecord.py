...
#
# model.add(Conv2D(32,(11,11),strides=(2,2),input_shape=(data_X.shape[1], data_X.shape[2],1),padding='valid',activation='relu',kernel_initializer='uniform'))
# model.add(MaxPooling2D(pool_size=(3,3)))
# model.add(Conv2D(64,(5,5),strides=(2,2),padding='valid',activation='relu',kernel_initializer='uniform'))
# model.add(MaxPooling2D(pool_size=(3,3)))
# # model.add(Conv2D(64,(3,3),strides=(2,2),padding='valid',activation='relu',kernel_initializer='uniform'))
# # model.add(MaxPooling2D(pool_size=(3,3)))
# model.add(Flatten())
...
# model.add(MaxPooling2D(pool_size=(5,5),strides=(2,2)))
# model.add(Dropout(0.2))
# model.add(Conv2D(64,(8,8),strides=(2,2),padding='same',activation='tanh',kernel_initializer='uniform'))
# model.add(Conv2D(32,(8,8),strides=(1,1),padding='same',activation='tanh',kernel_initializer='uniform'))#没有这一层是89%
...
#======================AlexNet==================================================
#
model.add(Conv2D(32,(11,11),strides=(2,2),input_shape=(data_X.shape[1], data_X.shape[2],1),padding='valid',activation='tanh',kernel_initializer='uniform'))
model.add(MaxPooling2D(pool_size=(3,3),strides=(2,2)))
model.add(Dropout(0.25))
model.add(Conv2D(32,(5,5),strides=(2,2),padding='same',activation='tanh',kernel_initializer='uniform'))
model.add(MaxPooling2D(pool_size=(3,3),strides=(2,2)))
model.add(Dropout(0.25))
model.add(Conv2D(64,(3,3),strides=(1,1),padding='same',activation='tanh',kernel_initializer='uniform'))
model.add(Conv2D(64,(3,3),strides=(1,1),padding='same',activation='tanh',kernel_initializer='uniform'))
...
history=model.fit(data_X,train_Y,epochs=1500,batch_size=10,validation_split=0.2)
...
data.save(r'E:\声音小组\LQPHP\audiotrack\matlab_code\handwriting\结果\acc_excel/20181206_lqp_812_ultraGesture_pauseRecordDemo_gray_picture_1024_512_1024_zeropading.xls')
